...
namespace Blaven.Data.EntityFramework.Tests
{
    public class RavenDbRepositoryTest
    {
        ...
        public void GetAllBlogMetas_ReturnsBlogMetasWithAllFieldValues()
        {
            ...
            var repository = GetEntityFrameworkRepository(blogMetas: dbBlogMetas);
        ...
        private static EntityFrameworkRepository GetEntityFrameworkRepository(
            IEnumerable<BlogMeta> blogMetas = null,
            IEnumerable<BlogPost> blogPosts = null)
        {
            var dbContext = BlavenDbContextTestFactory.Create();

            // TODO: Populate data from params
            //documentStore.BlogPosts.AddRange(blogPosts);
