...
namespace Blaven.Integration.Test
{
    ...
    public class BlogServiceTest : BlavenTestBase
    {
        ...
        public void Refresh_WithEnsureBlogsRefreshed_FollowingRefreshesShouldNotUpdate()
        {
            ...
            var results = new ConcurrentBag<BlogRefreshResult>();
            Parallel.For(
                0,
                _userCount,
                (i) =>
            ...
            var updatedCount =
                results.Count(x => x.ResultType == BlogRefreshResultType.UpdateSync || x.ResultType == BlogRefreshResultType.UpdateAsync);
        ...
        public void Refresh_WithoutEnsureBlogsRefreshed_FollowingRefreshesShouldUpdateSynchronously()
        {
            ...
            var updatedCount = results.Count(x => x.ResultType == BlogRefreshResultType.UpdateSync);
        ...
        public void Refresh_WithEnsureBlogsRefreshed_FollowingRefreshesWithForceRefreshShouldUpdateSynchronously()
        {
            ...
            var updatedCount = updated.Count(x => x.ResultType == BlogRefreshResultType.UpdateSync);
        ...
        public void Refresh_WithoutZeroMinutesCaching_FollowingRefreshesShouldNotUpdateSynchronously()
        {
            ...
            var secondRefreshResults = new ConcurrentBag<BlogRefreshResult>();
            Parallel.For(
                0,
                _userCount,
                (i) =>
            ...
            var updatedSynchronouslyCount = secondRefreshResults.Count(x => x.ResultType == BlogRefreshResultType.UpdateSync);
