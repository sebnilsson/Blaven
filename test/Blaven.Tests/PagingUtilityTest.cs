...
namespace Blaven.Tests
{
    public class PagingUtilityTest
    {
        ...
        public void GetPaged_PageIndexOne_ShouldReturnSecondPage(int pageSize)
        {
            ...
            // Act
            var pagedBlogPosts = PagingUtility.GetPaged(allBlogPosts, pageSize, 1).ToList();

            // Assert
            var pagedBlogPostsSequenceEquals = pagedBlogPosts.SequenceEqual(secondPageBlogPosts);
        ...
        public void GetPaged_PageIndexZero_ShouldReturnFirstPage(int pageSize)
        {
            ...
            // Act
            var pagedBlogPosts = PagingUtility.GetPaged(allBlogPosts, pageSize, 0).ToList();

            // Assert
            var pagedBlogPostsSequenceEquals = pagedBlogPosts.SequenceEqual(firstPageBlogPosts);
