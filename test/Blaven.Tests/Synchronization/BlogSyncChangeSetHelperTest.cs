...
namespace Blaven.Synchronization.Tests
{
    public class BlogSyncChangeSetHelperTest
    {
        ...
        public void GetChangeSet_LastUpdatedAtAfterLastDbPost_NoDeletedPosts()
        {
            ...
            var dataStoragePosts = TestData.GetBlogPosts(0, 5).ToList();
            ...
            // Act
            var changeSet = BlogSyncChangeSetHelper.GetChangeSet(TestData.BlogKey, sourcePosts, dbPostList);
        ...
        public void GetChangeSet_NoLastUpdatedAt_AllPostsDeleted()
        {
            ...
            // Act
            var changeSet = BlogSyncChangeSetHelper.GetChangeSet(TestData.BlogKey, sourcePosts, dataStoragePostList);
